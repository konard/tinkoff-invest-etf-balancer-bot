...
// Test utilities
export function setupHistoricalTestEnvironment() {
  // Setup mocks
  ...
  const testWorkspace = '/tmp/test-workspace-historical';
  ...
  mockFs.promises.stat.mockResolvedValue({ mtime: new Date() } as any);
...
export function teardownHistoricalTestEnvironment() {
